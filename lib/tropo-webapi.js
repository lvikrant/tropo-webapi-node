...
TropoWebAPI.prototype.startRecording = function(format, method, url, username, password, transcriptionID, transcriptionEmailFormat, transcriptionOutURI,transcriptionLanguage) {
    var startRecording = new base.StartRecording(format, method, url, username, password, transcriptionID, transcriptionEmailFormat, transcriptionOutURI, transcriptionLanguage);
